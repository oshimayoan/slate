...
fetch('https://api-staging.vospay.id/api/v1/accounts?phone={phone}?phone=08118289855?phone=08118289855',
{
  method: 'GET',
...
fetch('https://api-staging.vospay.id/api/v1/checkout/{vospayNumber}?merchantID={merchantID}?merchantID=1?merchantID=1',
{
  method: 'GET',
...
_Fetch installment plans given by the multifinance_
